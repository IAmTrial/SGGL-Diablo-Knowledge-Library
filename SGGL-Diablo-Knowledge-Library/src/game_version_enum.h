...
#ifndef SGGLDKL_GAME_VERSION_ENUM_H_
#define SGGLDKL_GAME_VERSION_ENUM_H_
...
enum GameVersion {
  ...
  DIABLO_II_1_02_BETA, DIABLO_II_1_02_STRESS_TEST_BETA,
...
#endif /* SGGLDKL_GAME_VERSION_ENUM_H_ */
